...
@Component({
  selector: 'app-accueil-collections',
  templateUrl: './accueil-collections.component.html',
  styleUrls: ['./accueil-collections.component.css']
})
export class AccueilCollectionsComponent {
