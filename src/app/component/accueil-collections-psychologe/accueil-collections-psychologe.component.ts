...
@Component({
  selector: 'app-accueil-collections-psychologe',
  templateUrl: './accueil-collections-psychologe.component.html',
  styleUrls: ['./accueil-collections-psychologe.component.css']
})
export class AccueilCollectionsPsychologeComponent {
  ...
  getall() {
    this.pubService.GetByType("Psychologe").subscribe((resultat: any) => {
      this.pub = resultat;
