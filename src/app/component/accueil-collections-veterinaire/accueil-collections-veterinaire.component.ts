...
@Component({
  selector: 'app-accueil-collections-veterinaire',
  templateUrl: './accueil-collections-veterinaire.component.html',
  styleUrls: ['./accueil-collections-veterinaire.component.css']
})
export class AccueilCollectionsVeterinaireComponent {
  ...
  getall() {
    this.pubService.GetByType("Veterinaire").subscribe((resultat: any) => {
      this.pub = resultat;
