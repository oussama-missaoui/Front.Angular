...
@Component({
  selector: 'app-accueil-collections-animalerie',
  templateUrl: './accueil-collections-animalerie.component.html',
  styleUrls: ['./accueil-collections-animalerie.component.css']
})
export class AccueilCollectionsAnimalerieComponent {
  ...
  getall() {
    this.pubService.GetByType("Animalerie").subscribe((resultat: any) => {
      this.pub = resultat;
